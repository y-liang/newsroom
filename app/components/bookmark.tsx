   ...
   return (
      <aside className='md:w-40'>
         <button
            ...
            className='flex items-center gap-2 text-sm text-slate-600 md:enabled:hover:text-slate-800 md:enabled:hover:bg-slate-100/75 px-2 py-1 rounded-full transition-colors font-normal'>
